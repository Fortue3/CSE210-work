...
public class ordinaryGoal : Goal
{
    private Boolean _accomplished = false;
    public ordinaryGoal()
    {
    }
    public ordinaryGoal(string goalType, string goalName, string description, int points, Boolean accomplished) : base(goalType, goalName, description, points)
    {
